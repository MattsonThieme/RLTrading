...
mem_capacity = 100000      # Size of the memory replay buffer
...
EPS_DECAY = 30000          # Steps between upper and lower bounds on epsilon
TARGET_UPDATE = 46000      # Examples between target network updates (want to keep this >10x policy_update)
POLICY_UPDATE = 3000       # Examples between policy updates
...
report_freq = 20           # Number of profitable trades to accumulate before reporting
